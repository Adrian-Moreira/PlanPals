...
class FlightFormTest extends StatefulWidget {
  final Function(Flight) onFlightSaved;

  const FlightFormTest({Key? key, required this.onFlightSaved})
      : super(key: key);
...
class _FlightFormState extends State<FlightFormTest> {
