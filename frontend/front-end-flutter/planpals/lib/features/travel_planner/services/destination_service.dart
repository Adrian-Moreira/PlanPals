...
class DestinationService {
  ...
  Future<void> updateDestination(
      String plannerId, String destinationId, Destination destination) async {
    try {
      await _apiService.patch(
          '${Urls.travelPlanner}/$plannerId/destination/$destinationId',
          destination.toJson());
    } catch (e) {
      throw Exception(
          'Failed to update destination ID=$destinationId for planner ID=$plannerId');
    }
  }
}
